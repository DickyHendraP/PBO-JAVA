 ...
 * @author dickypmngks
 */
public class RentalGameConsole extends AndOther{
    ...
    public static void main(String[] args) {
        ...
        if(jenisMember == "Silver") {
            ...
            System.out.println("Jumlah Cashback               : Rp. " + GMember.uangKembali);
            ...
            System.out.println("Jumlah Cashback               : Rp. " + PMember.uangKembali);
